...
namespace BibliotekaMvc.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(BibliotekaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Imie,Nazwisko,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Imie,Nazwisko,Email")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotekaContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
